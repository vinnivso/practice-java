        ...
        while (!sair) {
            ...
            if (opcao == 1) { //adicionar compromisso
                ...
                while (!mesValido) {
                    ...
                    mes = input.nextInt();
                    if (mes > 0 && mes <= 12) mesValido = true;
                    else System.out.println("Mês inválido, digite novamente");
                }
                ...
                while (!diaValido) {
                    ...
                    dia = input.nextInt();
                    if (dia > 0 && dia <= 31) diaValido = true;
                ...
                while (!horaValida) {
                    ...
                    hora = input.nextInt();
                    if (hora >= 0 && hora <= 8) horaValida = true;
                ...
                while (!horaValida) {
                    ...
                    hora = input.nextInt();
                    if (hora >= 0 && hora <= 24) horaValida = true;
                    else System.out.println("Hora inválida, digite novamente");
                }
